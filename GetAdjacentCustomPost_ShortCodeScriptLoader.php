...
include_once('GetAdjacentCustomPost_ShortCodeLoader.php');
 ...
 */
abstract class GetAdjacentCustomPost_ShortCodeScriptLoader extends GetAdjacentCustomPost_ShortCodeLoader {
